...
Name:          %{_base}js
Version:       0.10.48
Release:       1contrail%{_dist_ver}
Summary:       Node.js is a server-side JavaScript environment that uses an asynchronous event-driven model.
Packager:      Zheyang Song <zsong@juniper.net> (adapted from https://github.com/mozilla-services/nodejs-rpm-creator/blob/master/specs/node-v0.10.38.spec)
...
Prefix:        /usr
Provides:      %{_base}js = %{version}-%{release}
...
%changelog
* Wed Sep 27 2019 Zheyang Song <zsong@juniper.net>
- Updated to nodejs version 0.10.48
* Tue Mar 24 2015 Chris Kolosiwsky <ckolos@mozilla.com>
- Updated to nodejs version 0.10.38
